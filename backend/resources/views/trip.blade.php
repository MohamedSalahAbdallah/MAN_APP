...
<body>
    ...
    <form class="trip" id="trip" name="tripForm" method="post" action="">
        <fieldset>
            <legend><bdi>حجز تذكرة رحلات :</bdi></legend>
            <div class="formcontainer">
                <img alt="tripdestination" id="imgtripform" src="../Assets/Road Trip the Southwest.jfif">
                <div class="inputfield">
                    <label for="tripname"><bdi>إختر رحلتك :</bdi></label>
                    <select id="tripname" name="tripname" required>
                        <option value="">إختر :</option>
                        <!--For loop-->
                    </select>
                    <label for="free"><bdi>عدد التذاكر :</bdi></label>
                    <div class="freeprice">
                        <input type="number" min="0" value="0" name="free" id="free" accesskey="f">
                    ...
                    <input type="number" name="tripId" id="tripId" value="" hidden >
